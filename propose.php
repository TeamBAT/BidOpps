...
<html lang="en">
    ...
    <body>
        <nav class="navbar fixed-top" style="background-color:#20a8f7;">
            <a href="home.php" style="text-decoration:none;"><h2 class="navbar-brand" style="color:white;font-size:30px;font-family:'Nunito';"><i class="fa fa-home"></i> Bid Opportunities Admin</h2></a>
