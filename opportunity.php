...
<html lang="en">
    ...
    <body style="background: #8a8a5c">
        ...
        if (isset($_GET['id'])) {
            ...
            if (!$result)
                echo "Opportunity could not be fetched.";
            ...
            if (!$documents)
                echo "Documents couldn not be fetched.";
        }
        else {
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <?php if (isset($noResult)): echo "Opportunity 'id = " . $opportunity_id . "' does not exist.";
                    else:
                        ?>
                            ...
                            if (mysqli_num_rows($SolicitationDocuments) > 0):
                                while ($SolicitationDocument = mysqli_fetch_assoc($SolicitationDocuments)):
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                    endwhile;
                                else: echo "<td>No files found.</td><td></td><td></td>";
                                endif;
                                //End fetch rows
                                ?>
                            </tr>
                    ...
                    <div class="card-footer">
                        ...
                        <?php endif;
                        if ($opportunity['status'] == 'Submitted' && ($permissions['administrate'] || $permissions['review'])):
                            ?>
